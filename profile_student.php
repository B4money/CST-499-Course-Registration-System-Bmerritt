    ...
    //Username change attempt
     ...
     if ($unique_check = $conn->prepare('SELECT * FROM users WHERE username = ?')) {
        ...
        if ($unique_check->num_rows > 0) { 
            ...
            ?>
			<div class="container text-center">
            <form class="padding-top" role="form" action="profile.php" method="post" modelAttribute="student">
...
<form class="padding-top" role="form" action="profile.php" method="post" modelAttribute="student">
        ...
        <div class="form-group">
            ...
            <input class=" col-md-4 col-form-input" name='dob' type="date" value="<?php echo $my_dob;?>" />
        </div>
        <div class="form-group">
