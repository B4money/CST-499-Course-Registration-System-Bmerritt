...
<c:url var="administratorUrl" value="/administrator"/>
<?php
if (!(isset($_SESSION['title']))){$_SESSION['title'] = "Mx.";}
if (!(isset($_SESSION['email']))){$_SESSION['email'] = "administrator@uagc.edu";}
...
?>
<form action="connect.php" method="post" modelAttribute="administrator">
        ...
        <tr>
			<td colspan="2"><input type="submit" name='update_admistrator' value="Save profile" style="font-size:20px"></td>
		</tr>
    </form>
</body>
</html>