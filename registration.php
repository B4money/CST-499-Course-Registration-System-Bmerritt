...
if(isset($_POST['register']))
	...
	<form action="registration.php" method="post" modelAttribute="user">
        <div class="form-group">
            ...
            <input class="form" name='username' type="username" placeholder="Create a username"/>
        </div>
        <div class="form-group">
            <label for="password">Password</label>
            <input class="form" name='password' type="password" placeholder="Create a password"/>
        </div>
        <div class="form-group">
            <label for="first_name">First name</label>
            <input class="form" name='first_name' type="text" placeholder="John"/>
        </div>
        <div class="form-group">
            <label for="last_name">Last name</label>
            <input class="form" name='last_name' type="text" placeholder="Smith"/>
        </div>
        <tr>
			<td colspan="2"><input type="submit" name='register' value="Save User" style="font-size:20px"></td>
		</tr>
