...
<form class="padding-top" role="form" action="login.php" method="post" modelAttribute="user">
        ...
        <tr>
			<td colspan="2"><input style="color:green;" type="submit" name='login' value="Log in" style="font-size:20px"></td>
		</tr>
    </form>
</div>
