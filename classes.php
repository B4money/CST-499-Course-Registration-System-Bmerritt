...
if($_SESSION['role_id'] == 6){
    require_once 'classes_student.php';
    // teacher's aides will "enroll" in a class in the same way that a student would, 
	// since their information will not be listed on the class offering. 
	// But their role_id will allow them to not count against the occupancy/vacancy totals for the class.
}
