...
<div class="jumbotron" style="background-color: darkblue">
		<div class="container text-center">
			<h1 style="color:lightgreen;">Merritt University Online</h1>
		</div>
	</div>
...
echo '<li class="nav-item"><a class="nav-link active" href="chatbox.php"><span class="glyphicon glyphicon-briefcase"></span> Chat Box</a></li>';
echo '<li class="nav-item"><a class="nav-link active" href="roles.php"><span class="glyphicon glyphicon-briefcase"></span> Role</a></li>';
...
echo '<li class="nav-item"><a class="nav-link active" href="messages.php"><span class="glyphicon glyphicon-off"></span> My Notifications';
